    ...
    <div id="bitacora_bahias"
        ...
        <div class="card horizontal-card d-none ">
            ...
            <div>
                ...
                <input type="text" class="form-control" name="fecha_hora" id="fecha_hora_altabrisa_servicio" readonly>
            </div>
        </div>
        ...
        <div class="card horizontal-card d-none">
            <div class="form_group">
                ...
                <input type="text" class="form-control" name="id_formatos" id="formatos_altabrisa_servicio" readonly>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif ($campoNombre == 'Total surtido')
                                        <input type="decimal" class="form-control" id="campos[{{ $campo->id_campo }}]"
                                            name="campos[{{ $campo->id_campo }}]"
