        ...
        <div id="inventario_instalaciones" style="display: none;">
            ...
            <div class="card horizontal-card d-none">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="id_casetas" id="caseta_inventario_altabrisa"
                        readonly>
                </div>
                <div class="form-group">
                    <label for="id_turnos">Turno:</label>
                    <input type="text" class="form-control" name="id_turnos" id="turno_inventario_altabrisa"
                        readonly>
                </div>
                <div class="form-group">
                    <label for="Nombre_vigilante">Nombre de Vigilante:</label>
                    <input type="text" class="form-control" name="Nombre_vigilante"
                        id="Nombre_vigilante_invaltabrisa" readonly>
                </div>
                <div>
            ...
            <div class="card horizontal-card d-none">
                <div class="form_group">
                    ...
                    <input type="text" class="form-control" name="id_formatos" id="formatos_inventario_altabrisa"
                        readonly>
                </div>
            </div>
                ...
                @if ($campo = $campos->firstWhere('campo', $campoNombre))
                    <div class="form-group">
                        ...
                        @if ($campoNombre == 'Ubicación de la unidad')
                            <select class="form-control" id="campos[{{ $campo->id_campo }}]"
                                ...
                                @foreach ($ubicacion_unidad as $ubiunidad)
                                    <option value="{{ $ubiunidad->nombre }}">{{ $ubiunidad->nombre }}
                                    </option>
                                @endforeach
                        ...
                        @elseif ($campoNombre == 'Unidad')
                            ...
                            <!-- campo adicional para cuando se selecciona 'Otro' -->
                            <div class="textunidad" style="display: none; margin-top: 10px;">
                                <label for="otrotextunidad5">Especificar otra unidad</label>
                                <textarea class="form-control otrotextunidad" name="campos[{{ $campo->id_campo }}]" rows="4"
