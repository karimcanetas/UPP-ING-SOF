        ...
        <div id="registro_exhibicion" style="display: none;">
            ...
            <div class="card horizontal-card d-none">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Nombre_vigilante" id="Nombre_vigilante_exhibicion"
                        readonly>
                </div>
                <div class="form-group">
                    <label for="fecha_hora_nov_encierro">Fecha y hora del envío:</label>
                    <input type="text" class="form-control fechahora" name="fecha_hora" id="fecha_hora_exhibicion"
                        readonly>
                </div>
            </div>
