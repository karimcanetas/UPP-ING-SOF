    ...
    <div id="registro_exhibicion" style="display: none;">
        ...
        <div class="card horizontal-card d-none">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="id_casetas" id="caseta_exhibicion" readonly>
            </div>
            <div class="form-group">
                <label for="turno_nov_encierro">Turno:</label>
                <input type="text" class="form-control" name="id_turnos" id="turno_exhibicion" readonly>
            </div>
            <div class="form-group">
                <label for="Nombre_vigilante_nov_encierro">Nombre de Vigilante:</label>
                <input type="text" class="form-control" name="Nombre_vigilante" id="Nombre_vigilante_exhibicion" readonly>
            </div>
            <div class="form-group">
                <label for="fecha_hora_nov_encierro">Fecha y hora del envío:</label>
                <input type="text" class="form-control" name="fecha_hora" id="fecha_hora_exhibicion" readonly>
            </div>
        </div>
        ...
        <div class="card horizontal-card d-none">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="id_formatos" id="formatos_exhibicion" readonly>
            </div>
        </div>
