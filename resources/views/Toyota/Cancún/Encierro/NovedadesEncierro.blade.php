    ...
    <div id="Novedades_encierro" style="display: none;">
        <div class="card horizontal-card d-none">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="Nombre_vigilante" id="Nombre_vigilante_nov_encierro"
                    readonly>
            </div>
            <div class="form-group">
                <label for="fecha_hora_nov_encierro">Fecha y hora del envío:</label>
                <input type="text" class="form-control" name="fecha_hora" id="fecha_hora_nov_encierro" readonly>
            </div>
        </div>
        ...
        @foreach (['Detalle incidencia', 'Lt Gasolina Inicial', 'Lt Gasolina Final'] as $campoNombre)
            @if ($campo = $campos->firstWhere('campo', $campoNombre))
                <div class="form-group">
                    ...
                    @else
                        <input type="number" step="0.01" class="form-control" id="campos[{{ $campo->id_campo }}]"
