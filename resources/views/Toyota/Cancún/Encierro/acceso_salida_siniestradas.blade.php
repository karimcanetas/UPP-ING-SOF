    ...
    <div id="acceso_salida" style="display: none;">
        ...
        <div class="card horizontal-card d-none">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="Detalles" id="Detalles_salida" readonly>
            </div>
            <div class="form-group">
                <label for="lt_gasolina_inicial">Lt Gasolina Inicial:</label>
                <input type="text" class="form-control" name="lt_gasolina_inicial" id="lt_gasolina_inicial_encierro"
                    readonly>
            </div>
            <div class="form-group">
                <label for="lt_gasolina_final">Lt Gasolina Final:</label>
                <input type="text" class="form-control" name="lt_gasolina_final" id="lt_gasolina_final_encierro"
                    readonly>
            </div>
        </div>
