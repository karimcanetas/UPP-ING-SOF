...
<x-app-layout>
        ...
        <div class="container max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('correos_formatos.store') }}" class="needs-validation"
                        novalidate>
                        @csrf
                        <div class="row">
                            <!-- Empresa -->
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="id_sucursal" name="id_sucursal" required class="form-select shadow-sm"
                                    disabled>
                                ...
                                <div id="email-container" class="mb-3">
                                    <div class="input-group mb-2">
                                        ...
                                        <button type="button" class="btn btn-danger"
                                            onclick="removeEmail(this)">-</button>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select id="id_email" name="id_emails[]" class="form-select shadow-sm" multiple required>
                                <!-- Opciones se cargarán dinámicamente mediante AJAX -->
                            </select>
    ...
    `;
            ...
            if (emailValue) {
                fetch('/correos', {
                    ...
                    .then(data => {
                        ...
                        fetchEmails();
                        // Aquí puedes agregar lógica para mostrar el correo agregado en el UI
                    })
                    .catch(error => {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            fetchCorreos(); // Llama a la función para cargar los correos
            ...
            function fetchCorreos() {
                fetch('/correos')
                    ...
                    .then(data => {
                        ...
                        emailSelect.innerHTML = ''; // Limpia el select antes de llenarlo
                        data.forEach(correo => {
                            const option = document.createElement('option');
