    ...
    <div id="unidades_subaru" style="display: none;">
        ...
        <div class="card horizontal-card d-none">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="Nombre_vigilante" id="Nombre_vigilante_salidasubaru"
                    readonly>
            </div>
            <div>
        ...
        @foreach (['Fecha', 'Placas', 'VIN (6 últimos dígitos)', 'Hora de salida', 'KM de salida', 'Hora de entrada', 'KM de entrada', 'Nombre Taller', 'Persona que retira la unidad (Proveedor)', 'Folio / Num de pase', 'Observaciones / Comentarios'] as $campoNombre)
