    ...
    <div id="Control_subaru_servicio" style="display: none;">
        ...
        <div class="card horizontal-card d-none">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="Nombre_vigilante" id="Nombre_vigilante_estacionamientosub"
                    readonly>
            </div>
            <div>
                <label for="fecha_hora">Fecha y hora del envio</label>
                <input type="text" class="form-control" name="fecha_hora" id="fecha_hora_estacionamientosub" readonly>
            </div>
        </div>
        ...
        <div class="card horizontal-card d-none">
            <div class="form_group">
                ...
                <input type="text" class="form-control" name="id_formatos" id="formatos_estacionamiento_sub" readonly>
            </div>
        </div>
